...
class SFRData(DataPackage):
    ...
    dtypes = {'rno': np.int64, 'node': np.int64, 'k': np.int64, 'i': np.int64, 'j': np.int64,
              'iseg': np.int64, 'ireach': np.int64, 'outreach': np.int64, 'line_id': np.int64,
              'per': np.int64, 'nseg': np.int64, 'icalc': np.int64, 'outseg': np.int64,
              'iupseg': np.int64, 'iprior': np.int64, 'nstrpts': np.int64,
