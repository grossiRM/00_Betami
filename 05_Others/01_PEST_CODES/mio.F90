...
! -- Filenames
      ...
      character (len=500)                :: amessage=' ' ! Error message string
...
!    current parameter values and a set of model input template files.
        ...
        character (len=*), intent(in), optional          :: asldir ! slave directory
...
subroutine mio_read_model_output_files(ifail,nobs,aobs,obs,instruction,asldir)
